...
public final class ToastUtils {
    ...
    private static int yOffset =
            (int) (64 * App.getContext().getResources().getDisplayMetrics().density + 0.5);
    ...
    private static void show(@StringRes int resId, int duration) {
        show(App.getContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void show(@StringRes int resId, int duration, Object... args) {
        show(String.format(App.getContext().getResources().getString(resId), args), duration);
    }
